...
function PremiumVehicleVisual() {
  return (
    <motion.div
      initial={{ y: 36, opacity: 0, scale: 0.98 }}
      animate={{ y: 0, opacity: 1, scale: 1 }}
      transition={{ duration: 0.9, ease: "easeOut" }}
      className="relative overflow-hidden rounded-lg border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.10),rgba(255,255,255,0.035)),radial-gradient(circle_at_50%_0%,rgba(45,226,255,0.15),transparent_38%),linear-gradient(180deg,#0B1020_0%,#050816_100%)] p-4 shadow-[0_34px_120px_rgba(0,0,0,0.55)] backdrop-blur-xl sm:p-7"
    >
      <motion.div
        aria-hidden="true"
        animate={{ x: ["-130%", "130%"] }}
        transition={{ duration: 5.8, repeat: Infinity, ease: "easeInOut" }}
        className="absolute top-0 h-full w-1/3 rotate-12 bg-gradient-to-r from-transparent via-white/[0.15] to-transparent mix-blend-screen"
      />
      <div className="absolute left-5 top-5 z-10 flex max-w-[92%] flex-wrap gap-2">
        {["Premium Asian Fleet", "Warsaw Chopin Pilot", "EV / Hybrid / Selected ICE"].map(
          (label) => (
            <span
              key={label}
              className="rounded-full border border-white/10 bg-night/75 px-3 py-2 text-[0.66rem] font-semibold uppercase tracking-[0.14em] text-mist/80 backdrop-blur"
            >
              {label}
            </span>
          )
      ...
      <svg
        className="mx-auto mt-20 w-full max-w-5xl sm:mt-16"
        viewBox="0 0 1220 600"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        role="img"
        aria-label="Premium realistic 3D-style Asian crossover render"
      >
        <defs>
          <linearGradient id="investorFloor" x1="100" y1="420" x2="1100" y2="510">
            <stop stopColor="#2DE2FF" stopOpacity="0" />
            <stop offset="0.45" stopColor="#2DE2FF" stopOpacity="0.25" />
            <stop offset="0.76" stopColor="#B6FF4D" stopOpacity="0.12" />
            <stop offset="1" stopColor="#2DE2FF" stopOpacity="0" />
          </linearGradient>
          <linearGradient id="investorPaint" x1="178" y1="166" x2="1045" y2="430">
            <stop stopColor="#05070D" />
            <stop offset="0.18" stopColor="#14243A" />
            <stop offset="0.45" stopColor="#303B50" />
            <stop offset="0.66" stopColor="#0B1221" />
            <stop offset="1" stopColor="#03050A" />
          </linearGradient>
          <linearGradient id="investorHighlight" x1="207" y1="185" x2="1001" y2="321">
            <stop stopColor="#FFFFFF" stopOpacity="0.05" />
            <stop offset="0.45" stopColor="#2DE2FF" stopOpacity="0.27" />
            <stop offset="0.7" stopColor="#FFFFFF" stopOpacity="0.08" />
            <stop offset="1" stopColor="#B6FF4D" stopOpacity="0.12" />
          </linearGradient>
          <linearGradient id="investorGlass" x1="363" y1="108" x2="739" y2="255">
            <stop stopColor="#E8FCFF" stopOpacity="0.50" />
            <stop offset="0.34" stopColor="#2DE2FF" stopOpacity="0.18" />
            <stop offset="1" stopColor="#050816" stopOpacity="0.85" />
          </linearGradient>
          <radialGradient id="investorTire" cx="0" cy="0" r="1" gradientTransform="translate(0.5 0.5) rotate(90) scale(0.5)">
            <stop stopColor="#1A2230" />
            <stop offset="0.54" stopColor="#080B10" />
            <stop offset="1" stopColor="#000000" />
          </radialGradient>
          <radialGradient id="investorRim" cx="0" cy="0" r="1" gradientTransform="translate(0.46 0.38) rotate(90) scale(0.72)">
            <stop stopColor="#F6FBFF" />
            <stop offset="0.28" stopColor="#95A6BA" />
            <stop offset="0.55" stopColor="#293340" />
            <stop offset="1" stopColor="#070A0F" />
          </radialGradient>
          <filter id="investorShadow" x="-20%" y="-20%" width="140%" height="160%">
            <feGaussianBlur stdDeviation="24" />
          </filter>
          <filter id="investorGlow" x="-50%" y="-50%" width="200%" height="200%">
        ...
        <ellipse
          ...
          rx="470"
          ry="58"
          fill="url(#investorFloor)"
          opacity="0.75"
          filter="url(#investorShadow)"
        />
        ...
        <g transform="translate(16 4)">
          ...
          <path
            ...
            filter="url(#investorGlow)"
          />
          <path
            d="M214 329C248 303 292 293 352 295"
            stroke="rgba(45,226,255,0.90)"
            strokeWidth="8"
            strokeLinecap="round"
            filter="url(#investorGlow)"
          />
          ...
          <g transform="translate(320 417)">
            <circle r="78" fill="url(#investorTire)" stroke="rgba(255,255,255,0.16)" strokeWidth="10" />
            <circle r="49" fill="url(#investorRim)" />
          ...
          <g transform="translate(838 417)">
            <circle r="82" fill="url(#investorTire)" stroke="rgba(255,255,255,0.16)" strokeWidth="10" />
            <circle r="52" fill="url(#investorRim)" />
